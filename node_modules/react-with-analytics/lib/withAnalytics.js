...
exports.default = function (Component) {
  ...
  return _temp = _class = function (_React$PureComponent) {
    ...
    function WithAnalytics() {
      ...
      return _possibleConstructorReturn(this, (WithAnalytics.__proto__ || Object.getPrototypeOf(WithAnalytics)).apply(this, arguments));
    }
    ...
    _createClass(WithAnalytics, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (currentPage !== nextPage) (0, _utils.trackPage)(nextPage);
      }
    }, {
      key: 'render',
